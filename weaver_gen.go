...
func init() {
	codegen.Register(codegen.Registration{
		...
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return cache_local_stub{impl: impl.(Cache), tracer: tracer, getMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "01/Cache", Method: "Get", Remote: false}), putMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "01/Cache", Method: "Put", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return cache_client_stub{stub: stub, getMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "01/Cache", Method: "Get", Remote: true}), putMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "01/Cache", Method: "Put", Remote: true})}
		},
	...
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦7bfc482c:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→01/Searcher⟧\n⟦a234aa48:wEaVeRlIsTeNeRs:github.com/ServiceWeaver/weaver/Main→emojis⟧\n",
	})
	codegen.Register(codegen.Registration{
		Name:  "01/Reverser",
		...
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return reverser_local_stub{impl: impl.(Reverser), tracer: tracer, reverseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "01/Reverser", Method: "Reverse", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return reverser_client_stub{stub: stub, reverseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "01/Reverser", Method: "Reverse", Remote: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
	...
	codegen.Register(codegen.Registration{
		...
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return searcher_local_stub{impl: impl.(Searcher), tracer: tracer, searchMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "01/Searcher", Method: "Search", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return searcher_client_stub{stub: stub, searchMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "01/Searcher", Method: "Search", Remote: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
			return searcher_server_stub{impl: impl.(Searcher), addLoad: addLoad}
		},
		RefData: "⟦a198d433:wEaVeReDgE:01/Searcher→01/Cache⟧\n",
	})
}
